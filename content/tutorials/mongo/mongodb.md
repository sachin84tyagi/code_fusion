...
LinkedIn stores user profiles in MongoDB.
...
One document. All related data. No JOINs.
...
> MongoDB is a NoSQL, document-oriented database that stores data as JSON-like BSON documents in collections. It is flexible, scalable, and the default database for MERN stack applications.
...
## Q4. Is MongoDB schema-less?

Yes — collections don't enforce a fixed structure. Different documents in the same collection can have different fields. (Mongoose adds schema enforcement on top.)
...
We'll dive into **Collections** — what they are, how to create them, and how they differ from SQL tables.
