...
This tells you **where the command was executed from**.
...
Often sent by Docker or Kubernetes when asking your app to shut down gracefully.
...
We'll move to **Global Objects**, where you'll learn all the built-in globals that Node.js provides automatically without requiring any import.
